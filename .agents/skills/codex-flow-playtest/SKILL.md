...
Podaj wynik jako: scenariusz, środowisko, obserwowany rezultat, błędy konsoli/sieci, dowody, problemy i decyzja `zaliczony` albo `niezaliczony`. Playtest nie zastępuje testów jednostkowych ani `./scripts/verify.sh`.
