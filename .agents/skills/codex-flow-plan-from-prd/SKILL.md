...
6. Zaktualizuj `ROADMAP.md`. Każdy milestone musi mieć cel, weryfikowaną hipotezę, kryteria akceptacji, zakres, poza zakresem, testy, build, wymagany agentowy playtest techniczny oraz ryzyka lub zależności. Nie ustanawiaj ludzkiego lub zewnętrznego playtestu jako kryterium `done` albo bramki; taki feedback jest opcjonalny.
