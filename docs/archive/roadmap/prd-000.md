# Archiwum roadmapy PRD 000

Dokument zachowuje ukończony plan realizacji `prd/000-initial-prd.md`. Dozwolone statusy: `planned`, `in_progress`, `done`, `blocked`.
...
Dokument przeniesiono do archiwum po zakończeniu PRD 000 i utworzeniu aktywnej roadmapy PRD 001.
