...
- Następny milestone: `Milestone 9: Karty nagród i tożsamość przeciwników` (`planned`); wszystkie decyzje wejściowe są zatwierdzone.
- Aktywny zakres implementacyjny: brak.
...
- Milestone 9: `Backdoor Cut`, `Step Back`, `Hedge`, `Close Out` oraz profile `Fundamentals`, `Perimeter Crew`, `Paint Kings`.
- Milestone 10: grywalny trzy-meczowy pionowy przekrój, onboarding, nagrody i podsumowania.
...
- Następnie zaimplementować wyłącznie Milestone 9 za pomocą `$codex-flow-implement-milestone`.
- Nie implementować UI runu, checkpointu ani późniejszych milestone'ów w ramach Milestone 9.
...
- Brak blokera produktowego przed Milestone 9.
