...
| Data | Zakres | Wynik |
|---|---|---|
| 2026-08-15 | Stabilizacja timeoutów CI po review M10 `APPROVED` | Długie scenariusze E2E mają jawne budżety 360 s dla pełnego trzy-meczowego runu i 180 s dla oferty w dwóch viewportach, bez zmiany globalnego limitu 90 s. Test zakresowy przeszedł 2/2 w 4,0 min, a końcowy `./scripts/verify.sh` przeszedł limity kontekstu, lint, typecheck, 93/93 testy Vitest, build i 5/5 E2E w 4,5 min. Agentowy smoke techniczny M10 nadal obejmuje oba viewporty; M10 pozostaje `done`, a workflow kończy się po M10. |
